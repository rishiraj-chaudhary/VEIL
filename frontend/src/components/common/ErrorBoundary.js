        ...
        <div className="max-w-md w-full bg-slate-900 border border-slate-700 rounded-xl p-6 text-center">
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="px-5 py-2 bg-veil-purple hover:bg-veil-indigo text-veil-on-accent rounded-lg text-sm font-medium"
            >
              Try again
            </button>
            <a
              href="/"
              className="px-5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-sm"
            >
              Go home
            </a>
          </div>
