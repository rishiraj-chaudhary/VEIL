        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-5">
            ...
            >
              🎭 Slicks
              {currency.balance > 0 && (
                <span className="bg-veil-purple text-xs px-2 py-1 rounded-full">{currency.balance}</span>
              )}
            </Link>

            <div className="flex items-center space-x-3">
              <span className="text-gray-400 text-sm">{user?.username}</span>
              <span className="text-veil-purple font-semibold text-sm">{user?.karma || 0} karma</span>
            </div>
