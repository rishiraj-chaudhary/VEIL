...
const ScoreBreakdownModal = ({ turn, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-slate-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-slate-500/30">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Overall Score */}
          <div className="bg-gradient-to-r from-slate-900/50 to-slate-900/50 rounded-lg p-6 border border-slate-500/30">
            <div className="text-center">
              <div className="text-slate-300 mb-2">Overall Quality Score</div>
          ...
          {overallStep?.data?.formula && (
            <div className="bg-slate-900/20 border border-slate-500/30 rounded-lg p-5">
              <h3 className="text-xl font-bold text-slate-400 mb-3">
                📐 Calculation Formula
              </h3>
              <code className="block bg-slate-900 rounded p-4 text-sm text-slate-300 mb-4">
                {overallStep.data.formula}
              </code>
